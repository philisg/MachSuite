...
int main(int argc, char **argv)
{
  ...
  char *check_file;
  #endif
  assert( argc<5 && "Usage: ./benchmark <input_file> <check_file> <output_file>" );
  in_file = "input.data";
  ...
  printf("Input file loaded! Running benchmark!\n");// debug info
  
  // Unpack and call
  run_benchmark( data );

  Benchmark_done_running();
